...
public class TryAsync {
	...
	private static void handleException() {
		...
		// 2 independent async methods do not return
		...
		// 2 independent async methods with return value
		private static void thenAcceptBothMethod() {
			CompletableFuture<Void> compFuture = CompletableFuture.supplyAsync(() -> "Shiva").thenAcceptBoth(
					CompletableFuture.supplyAsync(() -> "Hello from "), (value2, value1) -> System.out.println(value1 + value2));
		}

		// all the async will be completed the time will be of the longest running method
		// all the method should return same type eg: <String>
		...
		// fist method that is completed would be used
